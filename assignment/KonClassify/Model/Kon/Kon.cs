...
namespace Model
{
    public partial class Kon
    {
        const string modelName = "Kon";
        ...
        /// <summary>
        /// Returns an instance of Kon model.
        /// </summary>
        public Kon()
        {
            ...
            string modelpath = Path.Combine(Path.GetDirectoryName(dllpath), "Kon");
        ...
        /// <summary>
        /// Returns instance of Kon model instantiated from exported model path.
        /// </summary>
        /// <param name="path">Exported model directory.</param>
        public Kon(string path)
        {
            manager = new ModelManager(path, true);
            manager.InitModel(modelName, int.MaxValue);
        }
